...
PGM_P PGM emberCommandTableZclPowerProfileEnergyPhasesScheduleCommandArguments[] = {
  "power profile id",
...
PGM_P PGM emberCommandTableZclPowerProfileEnergyPhasesScheduleStatesCommandArguments[] = {
  "power profile id",
  NULL
};

PGM_P PGM emberCommandTableZclPowerProfileProfileCommandArguments[] = {
  "power profile id",
  NULL
};

PGM_P PGM emberCommandTableZclPowerProfileScheduleConstraintsCommandArguments[] = {
  "power profile id",
  NULL
};

EmberCommandEntry emberCommandTableZclPowerProfileCommands[] = {
  emberCommandEntryActionWithDetails("energy-phases-schedule", zclPowerProfileEnergyPhasesScheduleCommand, "uub*", "The EnergyPhasesScheduleNotification Command is generated by a device  ...", emberCommandTableZclPowerProfileEnergyPhasesScheduleCommandArguments),
  emberCommandEntryActionWithDetails("energy-phases-schedule-states", zclPowerProfileEnergyPhasesScheduleStatesCommand, "u", "The EnergyPhasesScheduleStateRequest  Command is generated by a device ...", emberCommandTableZclPowerProfileEnergyPhasesScheduleStatesCommandArguments),
  emberCommandEntryActionWithDetails("profile", zclPowerProfileProfileCommand, "u", "The PowerProfileRequest Command is generated by a device supporting th ...", emberCommandTableZclPowerProfileProfileCommandArguments),
  emberCommandEntryActionWithDetails("schedule-constraints", zclPowerProfileScheduleConstraintsCommand, "u", "The PowerProfileScheduleConstraintsRequest Command is generated by a d ...", emberCommandTableZclPowerProfileScheduleConstraintsCommandArguments),
...
EmberCommandEntry emberCommandTableZclCommands[] = {
  ...
  emberCommandEntrySubMenu("power-profile", emberCommandTableZclPowerProfileCommands, ""),
...
PGM_P PGM emberCommandTablePluginSleepyMessageQueueGetNumMsgCommandArguments[] = {
  "The EUI64 of the device for which the number of pending messages is be ...",
  NULL
};

PGM_P PGM emberCommandTablePluginSleepyMessageQueueGetPendingMsgCommandArguments[] = {
  "The messageID of the message to be retrieved.",
  NULL
};

PGM_P PGM emberCommandTablePluginSleepyMessageQueueGetPendingMsgIdCommandArguments[] = {
  "The EUI64 of the device for which the first pending message ID is bein ...",
  NULL
};

PGM_P PGM emberCommandTablePluginSleepyMessageQueueRemainTimeCommandArguments[] = {
  "The messageID of the message whose remaining time will be reported.",
  NULL
};

PGM_P PGM emberCommandTablePluginSleepyMessageQueueRemoveCommandArguments[] = {
  "The messageID of the message to be removed.",
  NULL
};

PGM_P PGM emberCommandTablePluginSleepyMessageQueueRemoveAllCommandArguments[] = {
  "The EUI64 of the device whose messages should be removed.",
  NULL
};

PGM_P PGM emberCommandTablePluginSleepyMessageQueueStoreCommandArguments[] = {
...
EmberCommandEntry emberCommandTablePluginSleepyMessageQueueCommands[] = {
  emberCommandEntryActionWithDetails("getNumMsg", emAfSleepyMessageQueueCliGetNumPendingMsg, "b", "Get the number of pending messages for a given destination EUI64.", emberCommandTablePluginSleepyMessageQueueGetNumMsgCommandArguments),
  emberCommandEntryActionWithDetails("getPendingMsg", emAfSleepyMessageQueueCliGetPendingMsg, "u", "Get the first pending message ID for a given destination EUI64.", emberCommandTablePluginSleepyMessageQueueGetPendingMsgCommandArguments),
  emberCommandEntryActionWithDetails("getPendingMsgId", emAfSleepyMessageQueueCliGetPendingMsgId, "b", "Get the first pending message ID for a given destination EUI64.", emberCommandTablePluginSleepyMessageQueueGetPendingMsgIdCommandArguments),
  ...
  emberCommandEntryActionWithDetails("remainTime", emAfSleepyMessageQueueCliGetNextMessageEventTimeoutMs, "u", "Report the remaining timeout on the message specified by the message I ...", emberCommandTablePluginSleepyMessageQueueRemainTimeCommandArguments),
  emberCommandEntryActionWithDetails("remove", emAfSleepyMessageQueueCliRemoveMsgId, "u", "Remove the message from the queue with the given messageID.", emberCommandTablePluginSleepyMessageQueueRemoveCommandArguments),
  emberCommandEntryActionWithDetails("removeAll", emAfSleepyMessageQueueCliRemoveAllMsg, "b", "Remove all messages from the queue with the given EUI64.", emberCommandTablePluginSleepyMessageQueueRemoveAllCommandArguments),
  emberCommandEntryActionWithDetails("store", emAfSleepyMessageQueueCliStore, "wwvvb", "Store a message into the sleepy message queue.", emberCommandTablePluginSleepyMessageQueueStoreCommandArguments),
...
EmberCommandEntry emberCommandTablePluginCommands[] = {
  ...
  emberCommandEntrySubMenu("sleepy-message-queue", emberCommandTablePluginSleepyMessageQueueCommands, ""),
  emberCommandEntryTerminator()
};
